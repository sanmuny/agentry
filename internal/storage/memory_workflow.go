...
func (ms *MemoryStorage) StoreWorkflow(ctx context.Context, state *types.WorkflowState) error {
...
func (ms *MemoryStorage) GetWorkflow(ctx context.Context, workflowID string) (*types.WorkflowState, error) {
...
func (ms *MemoryStorage) ListTimedOutWorkflows(ctx context.Context) ([]*types.WorkflowState, error) {
	ms.workflowsMux.RLock()
	defer ms.workflowsMux.RUnlock()
